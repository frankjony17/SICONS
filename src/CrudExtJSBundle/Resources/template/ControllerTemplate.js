...
Ext.define('NAMESPACE', {
    ...
    control: {
        ...
        'XTYPEGRID [text=Adicionar]': {
            click: "showWindows"
        },
        'XTYPEGRID [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'XTYPEFORM': {
        ...
        'XTYPEFORM [text=Salvar]': {
            click: "isValid"
        },
        'XTYPEFORM [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('FORM', { autoShow: true, btnText: 'Salvar', title: 'Adicionar TITLE' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('FORM',{ btnText: 'Editar', title: 'Editar TITLE' }),
