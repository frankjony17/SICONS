...
class Roles extends \AdminBundle\Entity\Roles implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Roles' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\Roles' . "\0" . 'name', '' . "\0" . 'AdminBundle\\Entity\\Roles' . "\0" . 'role', '' . "\0" . 'AdminBundle\\Entity\\Roles' . "\0" . 'user');
        }
