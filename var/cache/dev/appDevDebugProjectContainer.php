...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.check' => 'getSecurity_Firewall_Map_Context_CheckService',
    ...
    /**
     * Gets the 'crud_ext_js.generator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CrudExtJSBundle\Services\Generator A CrudExtJSBundle\Services\Generator instance.
     */
    ...
    /**
     * Gets the 'crud_ext_js.util' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CrudExtJSBundle\Services\Util A CrudExtJSBundle\Services\Util instance.
     */
    ...
    /**
     * Gets the 'crud_ext_js.validator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CrudExtJSBundle\Services\Validators A CrudExtJSBundle\Services\Validators instance.
     */
    protected function getCrudExtJs_ValidatorService()
    {
        return $this->services['crud_ext_js.validator'] = new \CrudExtJSBundle\Services\Validators($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'sicons_db', 'user' => 'devusr', 'password' => 'devusr', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\AdminBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\NomencladorBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\ProyectoBundle\\Entity')));
        ...
        $d->setEntityNamespaces(array('AdminBundle' => 'AdminBundle\\Entity', 'NomencladorBundle' => 'NomencladorBundle\\Entity', 'ProyectoBundle' => 'ProyectoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9949fe89427dc329f376b273995183712eb311c205e9625aa686675781565138');
    ...
    /**
     * Gets the 'scs.util' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \NomencladorBundle\Services\Util A NomencladorBundle\Services\Util instance.
     */
    protected function getScs_UtilService()
    {
        return $this->services['scs.util'] = new \NomencladorBundle\Services\Util($this->get('doctrine.orm.default_entity_manager'), $this->get('validator'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AdminBundle\\Entity\\Users' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.check' => new \Symfony\Component\HttpFoundation\RequestMatcher('^login_check$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.check' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_CheckService()
    {
        return $this->services['security.firewall.map.context.check'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/reporte');

        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/proyecto');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/equipo/trabajo');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/especialista/calidad');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/revision/contrato');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/nomenclador');

        $m = new \Symfony\Component\Security\Http\AccessMap();
        $m->add($f, array(0 => 'ROLE_ADMIN'), NULL);
        $m->add($g, array(0 => 'ROLE_ADMIN'), NULL);
        $m->add($h, array(0 => 'ROLE_JEFE_DISENNO', 1 => 'ROLE_EQUIPO_TRABAJO', 2 => 'ROLE_ESPECIALISTA_CALIDAD'), NULL);
        $m->add($i, array(0 => 'ROLE_EQUIPO_TRABAJO'), NULL);
        $m->add($j, array(0 => 'ROLE_ESPECIALISTA_CALIDAD'), NULL);
        $m->add($k, array(0 => 'ROLE_ESPECIALISTA_CALIDAD'), NULL);
        $m->add($l, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_JEFE_DISENNO'), NULL);

        $n = new \Symfony\Component\Security\Http\HttpUtils($c, $c);

        $o = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $n, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($n, '_login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '_logout'));
        ...
        $p->setOptions(array('login_path' => '_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $p->setProviderKey('secured_area');

        $q = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($d, $n, array(), NULL);
        $q->setOptions(array('login_path' => '_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($m, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), NULL), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.our_db_provider')), 'secured_area', NULL, $b), 2 => $o, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $e, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $n, 'secured_area', $p, $q, array('check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), NULL, $b, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($a, $this->get('security.access.decision_manager'), $m, $e)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $n, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($d, $n, '_login', false), NULL, NULL, NULL, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\NomencladorBundle/Resources/views'), 'Nomenclador');
    ...
    {
        return $this->services['security.user.provider.concrete.our_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AdminBundle:Users', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NomencladorBundle' => 'NomencladorBundle\\NomencladorBundle',
                'ProyectoBundle' => 'ProyectoBundle\\ProyectoBundle',
                'ReporteBundle' => 'ReporteBundle\\ReporteBundle',
                'CrudExtJSBundle' => 'CrudExtJSBundle\\CrudExtJSBundle',
            ...
            'database_port' => 5432,
            'database_name' => 'sicons_db',
            'database_user' => 'devusr',
            'database_password' => 'devusr',
