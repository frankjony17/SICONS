 ...
 */
class Proyecto extends \ProyectoBundle\Entity\Proyecto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ProyectoBundle\\Entity\\Proyecto' . "\0" . 'id', '' . "\0" . 'ProyectoBundle\\Entity\\Proyecto' . "\0" . 'fecha', '' . "\0" . 'ProyectoBundle\\Entity\\Proyecto' . "\0" . 'codigo', '' . "\0" . 'ProyectoBundle\\Entity\\Proyecto' . "\0" . 'nombre', '' . "\0" . 'ProyectoBundle\\Entity\\Proyecto' . "\0" . 'grupo', '' . "\0" . 'ProyectoBundle\\Entity\\Proyecto' . "\0" . 'contrato', '' . "\0" . 'ProyectoBundle\\Entity\\Proyecto' . "\0" . 'descripcion', '' . "\0" . 'ProyectoBundle\\Entity\\Proyecto' . "\0" . 'estado', '' . "\0" . 'ProyectoBundle\\Entity\\Proyecto' . "\0" . 'proyectoTipo');
        }
    ...
    public function setProyectoTipo(\NomencladorBundle\Entity\ProyectoTipo $proyectoTipo = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProyectoTipo', array($proyectoTipo));

        return parent::setProyectoTipo($proyectoTipo);
    }
    ...
    public function getProyectoTipo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProyectoTipo', array());

        return parent::getProyectoTipo();
    }
