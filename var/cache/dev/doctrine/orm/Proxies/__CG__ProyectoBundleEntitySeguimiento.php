 ...
 */
class Seguimiento extends \ProyectoBundle\Entity\Seguimiento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ProyectoBundle\\Entity\\Seguimiento' . "\0" . 'id', '' . "\0" . 'ProyectoBundle\\Entity\\Seguimiento' . "\0" . 'orden', '' . "\0" . 'ProyectoBundle\\Entity\\Seguimiento' . "\0" . 'etapa');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Seguimiento $proxy) {
