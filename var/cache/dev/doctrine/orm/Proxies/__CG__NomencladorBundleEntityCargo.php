 ...
 */
class Cargo extends \NomencladorBundle\Entity\Cargo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'NomencladorBundle\\Entity\\Cargo' . "\0" . 'id', '' . "\0" . 'NomencladorBundle\\Entity\\Cargo' . "\0" . 'nombre', '' . "\0" . 'NomencladorBundle\\Entity\\Cargo' . "\0" . 'descripcion');
        }
