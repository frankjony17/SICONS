...
Ext.define('SCS.controller.nomenclador.FormatoController', {
    ...
    control: {
        ...
        'grid-formato [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-formato [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-formato': {
        ...
        'form-formato [text=Salvar]': {
            click: "isValid"
        },
        'form-formato [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('SCS.view.nomenclador.formato.FormatoForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Formato' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('SCS.view.nomenclador.formato.FormatoForm',{ btnText: 'Editar', title: 'Editar Formato' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/formato/remove',
