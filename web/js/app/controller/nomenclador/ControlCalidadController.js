...
Ext.define('SCS.controller.nomenclador.ControlCalidadController', {
    extend: 'Ext.app.Controller',

    control: {
        /* Grid */
        'grid-control_calidad': {
            afterrender: "afterRenderGrid",
            celldblclick: "dblclick",
            resize: "resize"
        },
        'grid-control_calidad [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-control_calidad [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-control_calidad': {
            afterrender: "afterRenderForm"
        },
        'form-control_calidad [text=Salvar]': {
            click: "isValid"
        },
        'form-control_calidad [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('SCS.view.nomenclador.control_calidad.ControlCalidadForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Control Calidad' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('SCS.view.nomenclador.control_calidad.ControlCalidadForm',{ btnText: 'Editar', title: 'Editar Control Calidad' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/control_calidad/remove',
