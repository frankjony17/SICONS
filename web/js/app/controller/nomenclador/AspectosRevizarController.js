...
Ext.define('SCS.controller.nomenclador.AspectosRevizarController', {
    extend: 'Ext.app.Controller',

    control: {
        /* Grid */
        'grid-aspectos_revizar': {
            afterrender: "afterRenderGrid",
            celldblclick: "dblclick",
            resize: "resize"
        },
        'grid-aspectos_revizar [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-aspectos_revizar [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-aspectos_revizar': {
            afterrender: "afterRenderForm"
        },
        'form-aspectos_revizar [text=Salvar]': {
            click: "isValid"
        },
        'form-aspectos_revizar [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('SCS.view.nomenclador.aspectos_revizar.AspectosRevizarForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Aspectos Revizar' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('SCS.view.nomenclador.aspectos_revizar.AspectosRevizarForm',{ btnText: 'Editar', title: 'Editar Aspectos Revizar' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/aspectos_revizar/remove',
