...
Ext.define('SCS.controller.nomenclador.ObjetosController', {
    ...
    control: {
        ...
        'grid-objetos [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-objetos [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-objetos': {
        ...
        'form-objetos [text=Salvar]': {
            click: "isValid"
        },
        'form-objetos [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('SCS.view.nomenclador.objetos.ObjetosForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Objetos' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('SCS.view.nomenclador.objetos.ObjetosForm',{ btnText: 'Editar', title: 'Editar Objetos' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/objetos/remove',
