...
Ext.define('SCS.controller.nomenclador.ElementoControlTipoController', {
    extend: 'Ext.app.Controller',

    control: {
        /* Grid */
        'grid-elemento_control_tipo': {
            afterrender: "afterRenderGrid",
            celldblclick: "dblclick",
            resize: "resize"
        },
        'grid-elemento_control_tipo [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-elemento_control_tipo [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-elemento_control_tipo': {
            afterrender: "afterRenderForm"
        },
        'form-elemento_control_tipo [text=Salvar]': {
            click: "isValid"
        },
        'form-elemento_control_tipo [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('SCS.view.nomenclador.elemento_control_tipo.ElementoControlTipoForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Elemento Control Tipo' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('SCS.view.nomenclador.elemento_control_tipo.ElementoControlTipoForm',{ btnText: 'Editar', title: 'Editar Elemento Control Tipo' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/elemento_control_tipo/remove',
