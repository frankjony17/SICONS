...
Ext.define('SCS.controller.nomenclador.EscalasController', {
    ...
    control: {
        ...
        'grid-escalas [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-escalas [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-escalas': {
        ...
        'form-escalas [text=Salvar]': {
            click: "isValid"
        },
        'form-escalas [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('SCS.view.nomenclador.escalas.EscalasForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Escalas' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('SCS.view.nomenclador.escalas.EscalasForm',{ btnText: 'Editar', title: 'Editar Escalas' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/escalas/remove',
