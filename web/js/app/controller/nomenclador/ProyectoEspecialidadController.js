...
Ext.define('SCS.controller.nomenclador.ProyectoEspecialidadController', {
    extend: 'Ext.app.Controller',

    control: {
        /* Grid */
        'grid-proyecto_especialidad': {
            afterrender: "afterRenderGrid",
            celldblclick: "dblclick",
            resize: "resize"
        },
        'grid-proyecto_especialidad [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-proyecto_especialidad [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-proyecto_especialidad': {
            afterrender: "afterRenderForm"
        },
        'form-proyecto_especialidad [text=Salvar]': {
            click: "isValid"
        },
        'form-proyecto_especialidad [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('SCS.view.nomenclador.proyecto_especialidad.ProyectoEspecialidadForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Proyecto Especialidad' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('SCS.view.nomenclador.proyecto_especialidad.ProyectoEspecialidadForm',{ btnText: 'Editar', title: 'Editar Proyecto Especialidad' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/proyecto_especialidad/remove',
