...
Ext.define('SCS.controller.nomenclador.PersonaTipoController', {
    ...
    control: {
        ...
        'grid-persona_tipo [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-persona_tipo [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-persona_tipo': {
        ...
        'form-persona_tipo [text=Salvar]': {
            click: "isValid"
        },
        'form-persona_tipo [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('SCS.view.nomenclador.persona_tipo.PersonaTipoForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Persona Tipo' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('SCS.view.nomenclador.persona_tipo.PersonaTipoForm',{ btnText: 'Editar', title: 'Editar Persona Tipo' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/persona_tipo/remove',
