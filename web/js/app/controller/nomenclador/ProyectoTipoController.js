...
Ext.define('SCS.controller.nomenclador.ProyectoTipoController', {
    ...
    control: {
        ...
        'grid-proyecto_tipo [text=Adicionar]': {
            click: "showWindows"
        },
        'grid-proyecto_tipo [text=Eliminar]': {
            click: "confirmRemove"
        },
        /* Form */
        'form-proyecto_tipo': {
        ...
        'form-proyecto_tipo [text=Salvar]': {
            click: "isValid"
        },
        'form-proyecto_tipo [text=Editar]': {
            click: "isValid"
        }
    },
    /*  */
    ...
    showWindows: function () {
        Ext.create('SCS.view.nomenclador.proyecto_tipo.ProyectoTipoForm', { autoShow: true, btnText: 'Salvar', title: 'Adicionar Proyecto Tipo' });
    },
    /*  */
    dblclick: function (view, td, cellIndex, record, tr, rowIndex) {

        var win = Ext.create('SCS.view.nomenclador.proyecto_tipo.ProyectoTipoForm',{ btnText: 'Editar', title: 'Editar Proyecto Tipo' }),
    ...
    remove: function () {
        ...
        Ext.Ajax.request({
            url: '../nomenclador/proyecto_tipo/remove',
