...
Ext.define('SCS.view.nomenclador.proyecto_especialidad.ProyectoEspecialidadGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'grid-proyecto_especialidad',
    /* Config options */
    width: '100%',
    border: 1,
    ...
    tbar : [{
        text: 'Adicionar',
        tooltip: 'Adicionar proyecto_especialidad',
        iconCls: 'fa fa-plus',
        action: 'add'
    },{
        text: 'Eliminar',
        tooltip: 'Eliminar proyecto_especialidad',
        iconCls: 'fa fa-trash',
        action: 'remove'
    }, '->', {
        tooltip: 'Ayuda relacionada con proyecto_especialidad',
        iconCls: 'fa fa-info',
        action: 'help'
    }]
});