...
Ext.define('SCS.view.equipotrabajo.tareaproyeccion.TareaProyeccionGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'tarea-proyeccion-grid',
    ...
    initComponent: function() {
        ...
        // Store
        me.store = Ext.create('SCS.store.TareaProyeccionStore');
